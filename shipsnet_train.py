...
if __name__ == "__main__":
    ...
    #'rwg','wg',
    for activation_iter in ['gaussian', 'laplace', 'uniform']:
        for prior_iter in ['relu','tanh','sigmoid','sinusoidal','relu6','wg','rwg']:
            for b_iter in [10.0, 1.0, 0.1]:
                pyro.clear_param_store()
                ...
                save_predictions_to_csv(all_labels, all_predictions, os.path.join('results_GP_shipsnet', f'predictions_{act_name}_{prior_name}_{experiment_timestamp}_{accuracy * 100:.0f}.csv'))