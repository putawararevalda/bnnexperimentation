## TODO MODIFY THE PYRO VARIABLE NAMES TO BE MORE GENERAL
...
class NewInjector:
    ...
    def run_seu(self, location_index, param_unique, parameter_name, layer, layer_module, bit_i, num_samples):
